...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
		//	'script_url' => $this->get_full_url().'/'.tradmin.'upload/'.$this->dir,
            'script_url' => $this->CI->admin_url.'upload/'.$this->dir,
            'upload_dir' => realpath(dirname(__DIR__)).'/../asset/data/'.$this->dir.'/',
            'upload_url' => base_url('/asset/data/'.$this->dir).'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
		...
		$this->options['image_versions'] = $dirAll;
        if ($options) {
	...
	{
		if($this->CI->session->userdata('dir'))
			$this->dir = $this->CI->session->userdata('dir');
		else
			$this->dir = '';
	}
	...
	//	$name = 'tr'.$this->generate_random_string(3).str_replace('.', 'up', microtime(true));
