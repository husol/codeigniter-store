				...
				<span class="input-group-btn">
					...
					<ul id="dropdown-cate" class="dropdown-menu custom-dropdown">
							...
							<?foreach($category[1] as $cate[1]){?>
								<li><a class="choose-category lv-1 <?=$cate[1]->cid == $default_tree_id ? 'cate-active' : ''?>" href="#" data-cid="<?=$cate[1]->cid?>" data-parent="<?=$cate[1]->c_parent?>" data-level="<?=$cate[1]->c_level?>" data-name="<?=$cate[1]->c_name?>"><span><?=$cate[1]->c_name?></span> | <span class="help-block"><?=$cate[1]->name_trans?></span></a>
									<?if(isset($category[2])){?>
										<ul>
											<?foreach($category[2] as $cate[2]){
												if($cate[2]->c_parent == $cate[1]->cid){?>
												<li><a class="choose-category lv-2 <?=$cate[2]->cid == $default_tree_id ? 'cate-active' : ''?>" href="#" data-cid="<?=$cate[2]->cid?>" data-parent="<?=$cate[2]->c_parent?>" data-level="<?=$cate[2]->c_level?>" data-name="<?=$cate[2]->c_name?>"><span><?=$cate[2]->c_name?></span> | <span class="help-block"><?=$cate[2]->name_trans?></span></a>
												<?if(isset($category[3])){?>
													<ul>
							...
							<li><a class="choose-category lv-1" href="#" data-cid="<?=$cate[1]->cid?>" data-parent="<?=$cate[1]->c_parent?>" data-level="<?=$cate[1]->c_level?>" data-name="<?=$cate[1]->c_name?>"><span><?=$cate[1]->c_name?></span> | <span class="help-block"><?=$cate[1]->name_trans?></span></a>
								<?if(isset($category[2])){?>
									<ul>
										<?foreach($category[2] as $cate[2]){
											if($cate[2]->c_parent == $cate[1]->cid){?>
											<li><a class="choose-category lv-2" href="#" data-cid="<?=$cate[2]->cid?>" data-parent="<?=$cate[2]->c_parent?>" data-level="<?=$cate[2]->c_level?>" data-name="<?=$cate[2]->c_name?>"><span><?=$cate[2]->c_name?></span> | <span class="help-block"><?=$cate[2]->name_trans?></span></a>
											<?if(isset($category[3])){?>
												<ul>
													<?foreach($category[3] as $cate[3]){
														if($cate[3]->c_parent == $cate[2]->cid){?>
